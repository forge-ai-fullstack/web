...
COUNTER_FILE = "htpc/iptv/fofa/计数.txt"
IP_DIR = "htpc/iptv/fofa/ip"
RTP_DIR = "htpc/iptv/fofa/rtp"
ZUBO_FILE = "htpc/iptv/fofa/zubo.txt"
IPTV_FILE = "htpc/iptv/fofa/IPTV.txt"
...
def push_all_files():
    ...
    os.system("git add htpc/iptv/fofa/计数.txt")
    os.system("git add htpc/iptv/fofa/ip/*.txt || true")
    os.system("git add htpc/iptv/fofa/IPTV.txt || true")
